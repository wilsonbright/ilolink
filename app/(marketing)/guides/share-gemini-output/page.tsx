      ...
      <PageHeader
        ...
        lead={
          <>
            ...
            ilolink.com/&lt;slug&gt;. Readers need no account. Then see how far
            readers got: views, scroll funnel, heatmaps, feedback.
          </>
        }
      />
      <Prose>
        ...
        <p>
          ...
          isolated origin. Forms are inert. The cap is 15 MB per doc.
        </p>
